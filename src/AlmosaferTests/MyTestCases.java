...
public class MyTestCases extends TestData {
	...
	public void HotelSearchTabCityInput() throws InterruptedException {
		...
		// find website language then choose the ar or eng data to fill
	...
	public void selectRoomOptionsRandomly() throws InterruptedException {
		WebElement rooms = driver.findElement(By.cssSelector(
				"div[class='__ds__comp undefined MuiBox-root alm-desktop-18m64ko'] div[class='MuiFormControl-root MuiTextField-root __ds__comp alm-desktop-72qxmm'] div[class='MuiInputBase-root MuiOutlinedInput-root MuiInputBase-colorPrimary MuiInputBase-formControl MuiInputBase-adornedStart alm-desktop-116o6k1']"));
		rooms.click();
		Thread.sleep(2000);

		List<WebElement> options = driver.findElements(By.cssSelector(
				"body > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > div:nth-child(3) > div:nth-child(1) > div:nth-child(1) > div:nth-child(2) > div:nth-child(1)"));
	...
	public void waitForSearchResults() {
		...
		String resultText = new WebDriverWait(driver, Duration.ofSeconds(100))
